...
| 模块 | 文档 | 接口数量 | 说明 |
|------|------|----------|------|
| 患者管理 | [api/api-patient.md](M01-门诊管理/api/api-patient.md) | 6 | 患者档案 CRUD |
| 挂号管理 | [api/api-register.md](M01-门诊管理/api/api-register.md) | 8 | 挂号、退号、叫号 |
| 门诊收费 | api/api-fee.md | 8 | 费用计算与收费 |
| 处方管理 | api/api-prescription.md | 7 | 处方开立与审核 |
| **汇总文档** | [api/README.md](M01-门诊管理/api/README.md) | ~79 | 门诊管理 API 汇总 |

### 5.2 M02-住院管理 API

| 模块 | 文档 | 接口数量 | 说明 |
|------|------|----------|------|
| 入院管理 | api/api-admission.md | 8 | 入院登记、床位分配 |
| 医嘱管理 | api/api-order.md | 10 | 医嘱开立、停止、作废 |
| 护理管理 | api/api-nursing.md | 8 | 护理记录、交接班 |
| 住院结算 | [api/api-settlement.md](M02-住院管理/api/api-settlement.md) | 10 | 费用结算、退费 |
| 住院费用 | [api/api-inpatient-fee.md](M02-住院管理/api/api-inpatient-fee.md) | 7 | 费用明细管理 |
| **汇总文档** | [api/README.md](M02-住院管理/api/README.md) | ~93 | 住院管理 API 汇总 |

### 5.3 M06-药品管理 API

| 模块 | 文档 | 接口数量 | 说明 |
|------|------|----------|------|
| 药品目录 | api/api-drug.md | 6 | 药品信息管理 |
| 药品库存 | api/api-drug-stock.md | 5 | 库存查询、预警 |
| 入库管理 | api/api-drug-inbound.md | 5 | 药品入库验收 |
| 出库管理 | api/api-drug-outbound.md | 5 | 药品出库管理 |
