...
VALUES ('预交金支付方式', 'his_prepayment_type', 0, '住院预交金支付方式');

INSERT INTO `system_dict_data` (`sort`, `label`, `value`, `dict_type`, `status`, `color_type`, `css_class`)
VALUES
(1, '现金', '1', 'his_prepayment_type', 0, 'default', ''),
(2, '银行卡', '2', 'his_prepayment_type', 0, 'primary', ''),
(3, '医保卡', '3', 'his_prepayment_type', 0, 'success', ''),
(4, '微信', '4', 'his_prepayment_type', 0, 'info', ''),
(5, '支付宝', '5', 'his_prepayment_type', 0, 'warning', ''),
(6, '混合支付', '6', 'his_prepayment_type', 0, 'danger', '');

INSERT INTO `system_dict_type` (`name`, `type`, `status`, `remark`)
VALUES ('预交金状态', 'his_prepayment_status', 0, '住院预交金状态');

INSERT INTO `system_dict_data` (`sort`, `label`, `value`, `dict_type`, `status`, `color_type`, `css_class`)
VALUES
(1, '已缴纳', '1', 'his_prepayment_status', 0, 'success', ''),
(2, '已使用', '2', 'his_prepayment_status', 0, 'warning', ''),
(3, '已退还', '3', 'his_prepayment_status', 0, 'info', ''),
(4, '已结算', '4', 'his_prepayment_status', 0, 'primary', '');

INSERT INTO `system_dict_type` (`name`, `type`, `status`, `remark`)
VALUES ('预交金退还状态', 'his_prepayment_refund_status', 0, '预交金退还状态');

INSERT INTO `system_dict_data` (`sort`, `label`, `value`, `dict_type`, `status`, `color_type`, `css_class`)
VALUES
(1, '申请中', '1', 'his_prepayment_refund_status', 0, 'warning', ''),
(2, '已审批', '2', 'his_prepayment_refund_status', 0, 'primary', ''),
(3, '已退还', '3', 'his_prepayment_refund_status', 0, 'success', ''),
(4, '已拒绝', '4', 'his_prepayment_refund_status', 0, 'danger', '');